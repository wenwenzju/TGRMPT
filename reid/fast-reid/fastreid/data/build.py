...
def add_info(cfg, kwargs):
    if 'IMAGE_ROOT' in cfg.DATASETS:
        kwargs["image_root"] = cfg.DATASETS.IMAGE_ROOT
    if 'INDEX_PREFIX' in cfg.DATASETS:
        kwargs["index_prefix"] = cfg.DATASETS.INDEX_PREFIX
    return kwargs
