...
tracker_method=deep_sort_concat
...
do
  ...
  do
    dis=`echo ${max_cosine_distance} | tr ' ' '_'`
    tracker_name=${tracker_method}_distance${dis}_budget${nn_budget}_age${max_age}
